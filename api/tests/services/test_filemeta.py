...
from api.services.filemeta import extension, is_binary, line_count
...
class LineCountCapTests(unittest.TestCase):
    ...
    def test_exact_count_below_threshold(self):
        from api.services.filemeta import line_count
...
class FileStatCacheTests(CacheRedirectMixin, unittest.TestCase):
    ...
    def test_warm_run_skipsline_count(self):
        ...
        with (
            patch("api.services.filemeta.line_count") as line_mock,
            patch("api.services.filemeta.is_binary") as binary_mock,
        ):
    ...
    def test_modified_file_recomputed(self):
        ...
        try:
            ...
            with patch(
                "api.services.filemeta.line_count", side_effect=counting_line_count
            ):
    ...
    def test_use_cache_false_bypasses_file_cache(self):
        ...
        with patch("api.services.filemeta.line_count", return_value=42) as line_mock:
