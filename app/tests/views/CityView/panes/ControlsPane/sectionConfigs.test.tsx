...
import { BUILDING_DIMENSIONS, BUILDINGS } from '@/city/session/settings/buildings';
import { GEM, GEM_SIZING, REPO_LABEL } from '@/city/session/settings/gem';
...
import { RAINBOW, BLOOM } from '@/city/session/settings/effects';
