...
import { createOrbitRings, ORBIT_RINGS_GROUP } from '@/city/scene/components/fireflies/orbitRings';
import type { FireflyPlacement } from '@/city/scene/components/fireflies/firefliesPlacement';
