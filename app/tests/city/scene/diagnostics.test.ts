...
import {
  ...
  auditTreeGrounding,
} from '@/city/scene/debug/diagnostics';
import { WorldRectKind } from '@/city/scene/layout/occupancyIndex';
import { LayoutOverlapCategory } from '@/city/scene/layout/overlaps';
