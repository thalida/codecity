...
import { WorldRectKind, WorldOccupancy } from '@/city/scene/layout/occupancyIndex';
...
import { findSmallestValidStem, placeChild } from '@/city/scene/layout/stemSolver';
import type { VariantTrace } from '@/city/scene/layout/stemSolver';
