...
import { createScrubController } from '@/city/scene/scrub/scrubController';
import type { ScrubGate } from '@/city/scene/scrub/scrubController';
import type { ScrubStates } from '@/city/scene/scrub/scrubPass';
import { BuildingLane } from '@/city/scene/components/buildings/scrubState';
