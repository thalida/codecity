// components/panes/PaneCloseButton/PaneCloseButton.tsx — puts a panel away rather
...
import { SidebarSideContext, SidebarSide } from '@/components/panes/Sidebar/Sidebar';
