...
const SCENE_FIELDS = {
  // ── Sky ──
  SKY_COLOR: { kind: FieldKind.Color, default: '#010005', label: 'Sky color',
...
const WORLD_FIELDS = {
  GROUND_BUFFER_PERCENT: { kind: FieldKind.Slider, default: 0, min: 0, max: 100, step: 1, label: 'Ground buffer (% of city)',
