...
export const GEM_SIZING = persistedSignal<GemSizingConfig>('GEM_SIZING', {
...
export const GEM_FACE_PALETTE = persistedSignal<GemFacePaletteConfig>('GEM_FACE_PALETTE', {
  FACE_1: faceHex(0),
  FACE_2: faceHex(1),
  FACE_3: faceHex(2),
  FACE_4: faceHex(3),
...
export const GEM_APPEARANCE = persistedSignal<GemAppearanceConfig>('GEM_APPEARANCE', {
  EDGE_COLOR: '#ffffff',
  BODY_OPACITY: 0.75,
});
...
export const GEM_GLOW = persistedSignal<GemGlowConfig>('GEM_GLOW', {
  ENABLED: true,
...
export const GEM_ANIMATION = persistedSignal<GemAnimationConfig>('GEM_ANIMATION', {
