...
export function CollapsibleSubgroup({ name, children }: CollapsibleSubgroupProps) {
  ...
  // Reset button is a sibling of <summary> (not nested inside) so it
  // doesn't trip the "interactive element inside summary" a11y rule.
  // CSS positions it absolutely over the right side of the summary row.
  return (
