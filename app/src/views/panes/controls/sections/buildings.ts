// views/panes/controls/sections/buildings.ts — Buildings section declaration.
...
import { BUILDING_DIMENSIONS, BUILDINGS, FACADE, BUILDING_FADE } from '@/state/settings/index';
