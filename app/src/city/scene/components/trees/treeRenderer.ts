...
import { interpolateOklch } from '@/city/scene/utils/color/colors';
import { setColorFromHex } from '@/city/scene/utils/color/setColorFromHex';

import { TREES_PER_CHUNK } from '@/city/scene/constants/chunkSize';
import { BYTE_MAX, VEC3_COMPONENTS, VERTS_PER_TRIANGLE } from '@/city/scene/constants/bufferLayout';
import { NEUTRAL_POLYGON_OFFSET } from '@/city/scene/constants/polygonOffset';
import treeVertSrc from './tree.vert.glsl?raw';
import treeFragSrc from './tree.frag.glsl?raw';
import { sunDir } from '@/city/scene/utils/shaders/sunDir';
import {
