...
import { getWorldBounds, type WorldBounds } from '@/city/scene/utils/floorBounds';
...
// Reads only ctx.build (to size itself reactively off latestWorldBounds —
