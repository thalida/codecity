// city/session/rebuildOnSave.ts — a committed change to THIS city's config →
// this city re-packing or refreshing. Two route-generated signatures, one
// effect each. See state/settings/README.md for how a route is declared.

import { computed, effect, untracked } from '@preact/signals';

import { RebuildStatus, type BuildReporter } from '@/city/session/stores/progress';
...
export function rebuildOnSave({ scene, report, config }: SettingsReactionsOpts): () => void {
