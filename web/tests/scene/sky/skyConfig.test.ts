...
describe('SKY_GRADIENT', () => {
  it('has the expected keys + defaults', () => {
    ...
    expect(v.TOP).toBe('#01010a');
    expect(v.UPPER_MID).toBe('#040315');
    expect(v.MID).toBe('#080525');
    expect(v.LOWER_MID).toBe('#100835');
    expect(v.HORIZON).toBe('#1f1050');
    expect(v.GROUND_COLOR).toBe('#02020a');
...
describe('SKY_STARS', () => {
  it('has the expected keys + defaults', () => {
    ...
    expect(v.ENABLED).toBe(true);
    expect(v.DENSITY).toBeCloseTo(0.01);
