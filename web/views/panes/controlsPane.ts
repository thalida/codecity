...
function _buildRenderingSection(): HTMLElement {
  ...
  section.appendChild(
    _subgroup('Level of detail (cell mode)', [
      ...
      _number('Detail at (% of viewport)', LOD, 'DETAIL_VIEWPORT_FRAC', 0.0001, 0.5, 0.005, {
      ...
      _number('Impostor at (% of viewport)', LOD, 'IMPOSTOR_VIEWPORT_FRAC', 0.00001, 0.5, 0.001, {
      ...
      _number('Cull below (% of viewport)', LOD, 'CULL_VIEWPORT_FRAC', 0, 0.01, 0.00001, {
