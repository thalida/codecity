// city/components/buildings/atlas.ts — Build a single texture atlas of Material Icon
...
import { DirNode, FileNode, Manifest, NodeKind, TreeNode } from '../../types/manifest';
