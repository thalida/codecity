// features/settings/state/reactions.ts — the "rebuilding" flash on a Save the city
// answers by refreshing materials rather than re-packing. See README.md.

import { ChangeRoute, type City } from '@codecity/city';

import { HOST_WORK, beginHostWork, endHostWork } from '@/features/city/state/readout';
