...
(`features/city/components/panes/ControlsPane/sectionConfigs/`). A field declares what it
...
(`features/city/components/CityFooter/transferGroups.ts`). Render's groups are read
