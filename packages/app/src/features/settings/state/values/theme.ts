// features/settings/state/values/theme.ts — accent + surface presets, applied by setting
...
import { markSettingStore, markAutosave } from '@/features/settings/state/schema';
