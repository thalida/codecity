// features/settings/state/indicators.ts — the dirty dot on the Settings icon. Only what
// the pane can take you to counts, since pointing there is the dot's whole job.

import { computed } from '@preact/signals';
import { forEachSettingStore, getFieldKeys } from '@/features/settings/state/schema';
