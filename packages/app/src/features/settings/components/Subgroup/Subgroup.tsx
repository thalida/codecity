// features/settings/components/Subgroup/Subgroup.tsx — a labelled group of control rows, collapsible with a
...
import { stageReset } from '@/features/settings/state/drafts';
