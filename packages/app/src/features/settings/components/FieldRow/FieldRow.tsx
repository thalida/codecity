// features/settings/components/FieldRow/FieldRow.tsx — a labelled control-panel row.
...
import { ResetButton } from '@/features/settings/components/ResetButton/ResetButton';
