// features/settings/components/SwatchField/SwatchField.tsx — one theme axis as a radiogroup of colour
...
import { getEffective, setDraft, stageReset } from '@/features/settings/state/drafts';
import type { ThemePresetOption } from '@/features/settings/state/values/theme';
