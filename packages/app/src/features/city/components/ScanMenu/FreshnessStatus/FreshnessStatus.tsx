// features/city/components/ScanMenu/FreshnessStatus/FreshnessStatus.tsx — how fresh the loaded city is.
...
import { LIVE_UPDATES_ACTIVE } from '@/features/settings/state/values/updates';
import { CityLifecycle } from '@codecity/city';
import { useCityStatus } from '@codecity/city/preact';
import { HOST_WORK, LAST_UPDATED_AT, REBUILD_DETAIL } from '@/features/city/state/readout';
