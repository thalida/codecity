// features/city/components/ScanMenu/ScanMenu.tsx — the freshness readout as a trigger, over
...
import {
  FreshnessStatus,
  useFreshness,
} from '@/features/city/components/ScanMenu/FreshnessStatus/FreshnessStatus';
