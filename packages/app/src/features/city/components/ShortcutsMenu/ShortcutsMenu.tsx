// features/city/components/ShortcutsMenu/ShortcutsMenu.tsx — the keyboard and mouse
// reference. Open state lives in SHORTCUTS_OPEN, not inside the popover, since
// "?" opens it from anywhere and OVERLAY_OPEN reads it.
