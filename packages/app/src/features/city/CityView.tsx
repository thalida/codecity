...
import { CityStage } from '@/features/city/components/CityStage/CityStage';
...
} from '@/features/city/state/commands';
...
function CityChrome({ city }: { city: City | null }) {
  ...
  useEffect(() => {
    ...
    void import('@/features/city/capture/captureHarness').then((m) => m.captureCity(city));
  }, [city]);
