...
import { useHomeBackdrop } from '@/features/home/hooks/useHomeBackdrop';
import { BACKDROP_SETTINGS } from '@/features/settings/state/values/city';
import { GemIcon } from '@/components/GemIcon/GemIcon';
import { MetaLine } from '@/components/MetaLine/MetaLine';
import { type SourcePayload, SOURCE_ERROR } from '@/state/source';
import { BACKDROP_CITY } from '@/features/home/backdrop';
import { RECENTS } from '@/state/recents';
import { cityHref, navigate } from '@/router/location';
import { useServerConfig, useDiscover } from '@/api/reads';
...
import { DiscoverList } from '@/features/home/components/sources/DiscoverList/DiscoverList';
