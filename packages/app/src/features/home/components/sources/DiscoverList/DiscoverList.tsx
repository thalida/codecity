// features/home/components/sources/DiscoverList/DiscoverList.tsx — the curated repos, as the
...
import { ACTIVE_SOURCE } from '@/features/home/backdrop';
import { useDiscover } from '@/api/reads';
import {} from '@/state/source';
import { sameSourceIdentity } from '@codecity/city';
import { SourceRow } from '@/features/home/components/sources/SourceRow/SourceRow';
import { cityHref } from '@/router/location';

export function DiscoverList() {
  const repos = useDiscover();
