// components/settings/DynamicSection/DynamicSection.tsx — turns one section config into the Section /
// Subgroup / Field shells, recursively.

import { Section } from '@/components/settings/Section/Section';
