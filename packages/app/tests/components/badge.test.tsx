...
// The two stores the badge reads. They are generated from the city's own CITY_FIELDS now, so
// the whole set is one module and the mock replaces the two entries rather than two files.
